...
from pyacp.models.cluster_report_card_group import ClusterReportCardGroup


class TestClusterReportCardGroup(unittest.TestCase):
    """ ClusterReportCardGroup unit test stubs """
    ...
    def testClusterReportCardGroup(self):
        """
        Test ClusterReportCardGroup
        """
        model = pyacp.models.cluster_report_card_group.ClusterReportCardGroup()
