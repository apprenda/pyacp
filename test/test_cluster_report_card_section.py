...
from pyacp.models.cluster_report_card_section import ClusterReportCardSection


class TestClusterReportCardSection(unittest.TestCase):
    """ ClusterReportCardSection unit test stubs """
    ...
    def testClusterReportCardSection(self):
        """
        Test ClusterReportCardSection
        """
        model = pyacp.models.cluster_report_card_section.ClusterReportCardSection()
