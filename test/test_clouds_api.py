...
from swagger_client.apis.clouds_api import CloudsApi
...
class TestCloudsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = swagger_client.apis.clouds_api.CloudsApi()

    def tearDown(self):
        pass

    def test_clouds_get_by_id_p_ublic(self):
        """
        Test case for clouds_get_by_id_p_ublic

        Get cloud
        """
        pass

    def test_clouds_get_public(self):
        """
        Test case for clouds_get_public
