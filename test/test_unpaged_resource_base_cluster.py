...
from pyacp.models.unpaged_resource_base_cluster import UnpagedResourceBaseCluster


class TestUnpagedResourceBaseCluster(unittest.TestCase):
    """ UnpagedResourceBaseCluster unit test stubs """
    ...
    def testUnpagedResourceBaseCluster(self):
        """
        Test UnpagedResourceBaseCluster
        """
        model = pyacp.models.unpaged_resource_base_cluster.UnpagedResourceBaseCluster()
