...
from pyacp.apis.node_state_api import NodeStateApi


class TestNodeStateApi(unittest.TestCase):
    """ NodeStateApi unit test stubs """

    def setUp(self):
        self.api = pyacp.apis.node_state_api.NodeStateApi()
