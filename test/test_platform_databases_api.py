...
from pyacp.apis.platform_databases_api import PlatformDatabasesApi


class TestPlatformDatabasesApi(unittest.TestCase):
    """ PlatformDatabasesApi unit test stubs """

    def setUp(self):
        self.api = pyacp.apis.platform_databases_api.PlatformDatabasesApi()

    def tearDown(self):
        pass

    def test_api_v1_platformdatabases_db_alias_get(self):
        """
        Test case for api_v1_platformdatabases_db_alias_get

        
        """
        pass

    def test_api_v1_platformdatabases_get(self):
        """
        Test case for api_v1_platformdatabases_get
