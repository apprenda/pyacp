...
from pyacp.models.encryption_result import EncryptionResult


class TestEncryptionResult(unittest.TestCase):
    """ EncryptionResult unit test stubs """
    ...
    def testEncryptionResult(self):
        """
        Test EncryptionResult
        """
        model = pyacp.models.encryption_result.EncryptionResult()
