...
class TestHostsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pyacp.apis.hosts_api.HostsApi()

    def tearDown(self):
        pass

    def test_api_v1_hosts_host_name_is_transitioning_get(self):
        """
        Test case for api_v1_hosts_host_name_is_transitioning_get

        Check server transition
        """
        pass

    def test_api_v1_hosts_host_name_state_get(self):
        """
        Test case for api_v1_hosts_host_name_state_get

        Get server state
        """
        pass

    def test_api_v1_hosts_host_name_state_put(self):
        """
        Test case for api_v1_hosts_host_name_state_put
