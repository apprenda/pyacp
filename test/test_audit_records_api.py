...
from pyacp.apis.audit_records_api import AuditRecordsApi
...
class TestAuditRecordsApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pyacp.apis.audit_records_api.AuditRecordsApi()

    def tearDown(self):
        pass

    def test_audit_records_export(self):
        """
        Test case for audit_records_export
