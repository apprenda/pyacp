...
class TestComponentsApi(unittest.TestCase):
    ...
    def test_components_get_by_alias(self):
        """
        Test case for components_get_by_alias

        Get an application component
        """
        pass

    def test_get_workloads_by_id(self):
        """
        Test case for get_workloads_by_id

        Get workload
        """
        pass

    def test_get_workloads_for_components(self):
        """
        Test case for get_workloads_for_components

        Get all workloads
        """
        pass

    def test_post_workloads(self):
        """
        Test case for post_workloads
