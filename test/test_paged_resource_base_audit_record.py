...
from pyacp.models.paged_resource_base_audit_record import PagedResourceBaseAuditRecord


class TestPagedResourceBaseAuditRecord(unittest.TestCase):
    """ PagedResourceBaseAuditRecord unit test stubs """
    ...
    def testPagedResourceBaseAuditRecord(self):
        """
        Test PagedResourceBaseAuditRecord
        """
        model = pyacp.models.paged_resource_base_audit_record.PagedResourceBaseAuditRecord()
