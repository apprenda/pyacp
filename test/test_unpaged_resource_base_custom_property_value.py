...
from pyacp.models.unpaged_resource_base_custom_property_value import UnpagedResourceBaseCustomPropertyValue


class TestUnpagedResourceBaseCustomPropertyValue(unittest.TestCase):
    """ UnpagedResourceBaseCustomPropertyValue unit test stubs """
    ...
    def testUnpagedResourceBaseCustomPropertyValue(self):
        """
        Test UnpagedResourceBaseCustomPropertyValue
        """
        model = pyacp.models.unpaged_resource_base_custom_property_value.UnpagedResourceBaseCustomPropertyValue()
