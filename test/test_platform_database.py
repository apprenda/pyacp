...
from pyacp.models.platform_database import PlatformDatabase


class TestPlatformDatabase(unittest.TestCase):
    """ PlatformDatabase unit test stubs """
    ...
    def testPlatformDatabase(self):
        """
        Test PlatformDatabase
        """
        model = pyacp.models.platform_database.PlatformDatabase()
