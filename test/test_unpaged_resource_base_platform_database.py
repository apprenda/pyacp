...
from pyacp.models.unpaged_resource_base_platform_database import UnpagedResourceBasePlatformDatabase


class TestUnpagedResourceBasePlatformDatabase(unittest.TestCase):
    """ UnpagedResourceBasePlatformDatabase unit test stubs """
    ...
    def testUnpagedResourceBasePlatformDatabase(self):
        """
        Test UnpagedResourceBasePlatformDatabase
        """
        model = pyacp.models.unpaged_resource_base_platform_database.UnpagedResourceBasePlatformDatabase()
