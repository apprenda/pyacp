...
from pyacp.models.encryption_request import EncryptionRequest


class TestEncryptionRequest(unittest.TestCase):
    """ EncryptionRequest unit test stubs """
    ...
    def testEncryptionRequest(self):
        """
        Test EncryptionRequest
        """
        model = pyacp.models.encryption_request.EncryptionRequest()
