...
from pyacp.models.paged_resource_base_node import PagedResourceBaseNode


class TestPagedResourceBaseNode(unittest.TestCase):
    """ PagedResourceBaseNode unit test stubs """
    ...
    def testPagedResourceBaseNode(self):
        """
        Test PagedResourceBaseNode
        """
        model = pyacp.models.paged_resource_base_node.PagedResourceBaseNode()
