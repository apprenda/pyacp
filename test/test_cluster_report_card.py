...
from pyacp.models.cluster_report_card import ClusterReportCard


class TestClusterReportCard(unittest.TestCase):
    """ ClusterReportCard unit test stubs """
    ...
    def testClusterReportCard(self):
        """
        Test ClusterReportCard
        """
        model = pyacp.models.cluster_report_card.ClusterReportCard()
