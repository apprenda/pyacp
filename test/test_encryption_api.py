...
from pyacp.apis.encryption_api import EncryptionApi
...
class TestEncryptionApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = pyacp.apis.encryption_api.EncryptionApi()

    def tearDown(self):
        pass

    def test_api_v1_services_encryption_post(self):
        """
        Test case for api_v1_services_encryption_post
