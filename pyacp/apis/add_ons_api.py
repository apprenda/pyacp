...
class AddOnsApi(object):
    ...
    def add_on_get(self, **kwargs):
        ...
        **Requires Platform version 6.7.0 or later.**   Returns a list of all Add-Ons for the Platform. 
        ...
        :param callback function: The callback function
            for asynchronous request. (optional)
        :return: list[UnpagedResourceBaseAddOn]
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
    ...
    def add_on_get_with_http_info(self, **kwargs):
        ...
        **Requires Platform version 6.7.0 or later.**   Returns a list of all Add-Ons for the Platform. 
        ...
        return self.api_client.call_api(resource_path, 'GET',
                                        ...
                                        post_params=form_params,
                                        files=local_var_files,
                                        response_type='list[UnpagedResourceBaseAddOn]',
                                        auth_settings=auth_settings,
                                        callback=params.get('callback'),
                                        _return_http_data_only=params.get('_return_http_data_only'),
                                        _preload_content=params.get('_preload_content', True),
    ...
    def upload_addon_archive_file(self, addon_alias, file, **kwargs):
        """
        ...
        **Requires Platform version 6.7.0 or later.**   Uploads an Add-On archive to the Platform. This will replace any binaries attached to the Add-On with the new upload.  
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_addon_archive_file(addon_alias, file, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str addon_alias: Required. Alias of the Add-On to update (required)
        :param file file: Archive for the Add-on (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.upload_addon_archive_file_with_http_info(addon_alias, file, **kwargs)
        else:
            (data) = self.upload_addon_archive_file_with_http_info(addon_alias, file, **kwargs)
            return data

    def upload_addon_archive_file_with_http_info(self, addon_alias, file, **kwargs):
        """
        Upload Add-On archive
        **Requires Platform version 6.7.0 or later.**   Uploads an Add-On archive to the Platform. This will replace any binaries attached to the Add-On with the new upload.  
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_addon_archive_file_with_http_info(addon_alias, file, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method upload_addon_archive_file" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'addon_alias' is set
        if ('addon_alias' not in params) or (params['addon_alias'] is None):
            raise ValueError("Missing the required parameter `addon_alias` when calling `upload_addon_archive_file`")
        # verify the required parameter 'file' is set
        if ('file' not in params) or (params['file'] is None):
            raise ValueError("Missing the required parameter `file` when calling `upload_addon_archive_file`")


        collection_formats = {}

        resource_path = '/api/v1/addons/{addonAlias}/archive'.replace('{format}', 'json')
        path_params = {}
        if 'addon_alias' in params:
            path_params['addonAlias'] = params['addon_alias']
