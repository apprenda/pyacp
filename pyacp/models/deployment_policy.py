...
class DeploymentPolicy(object):
    ...
    """
    def __init__(self, name=None, description=None, active=None, applies_to_sandbox=None, applies_to_published=None, source_object_type=None, property_name=None, property_display_name=None, policy_applicability=None, policy_condition=None, priority=None, href=None):
        """
